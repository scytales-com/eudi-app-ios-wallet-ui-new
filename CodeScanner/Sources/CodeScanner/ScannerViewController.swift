...
extension CodeScannerView {
    ...
    public final class ScannerViewController: UIViewController, UINavigationControllerDelegate {
        ...
        override public func loadView() {
            ...
            label.text = "You're running in the simulator, which means the camera isn't available. Tap anywhere to send back some simulated data or enter qr code in the text field below"
        ...
        var simulatedData: String {
            if let tft = textView.text, !tft.isEmpty { tft } else { parentView.simulatedData }
        }
